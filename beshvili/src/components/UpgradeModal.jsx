...
const PLANS = [
  {
    ...
    pages: 10,
    color: "blue",
    features: ["5 חוברות לחודש (בכל גודל)", "עד 10 עמודים לחוברת", "מפתח תשובות", "שמירה בענן"],
  },
  {
    id: "teacher",
    icon: "🚀",
    ...
    color: "purple",
    badge: "מומלץ",
    features: ["20 חוברות לחודש (בכל גודל)", "עד 20 עמודים לחוברת — עמודים לא נספרים במכסה", "מפתח תשובות אוטומטי", "ניהול פרופילי תלמידים", "שמירה בענן לצמיתות", "תמיכה אישית ישירה"],
  },
];
