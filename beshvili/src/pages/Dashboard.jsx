      ...
      <div className="lg:mr-60 pb-20 lg:pb-0">
        <main className="max-w-3xl mx-auto px-5 py-6 lg:py-8">
          ...
          {tab === "history" && <History isPro={isPro} onUpgrade={() => setShowUpgrade(true)} onCreateNew={() => setTab("create")}
            onCreateSimilar={(b, extras = {}) => { setPendingStarter({ childName: b.child_name || "", grade: b.grade || "", world: b.world || "כדורגל", goal: b.goal || "", level: b.level || "medium", weaknesses: extras.weaknesses || "" }); setTab("create"); }}
          />}
