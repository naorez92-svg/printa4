...
• חינם: 2 חוברות לכל משתמש (עד 2 עמודים כל אחת). תוכניות: הורה ₪19/חודש (5 חוברות, עד 10 עמודים, מפתח תשובות), מורה פרטית ₪59/חודש (20 חוברות, עד 20 עמודים, מפתח תשובות, ניהול תלמידים, מיתוג אישי).
• מבצע חודש ראשון (כשמופיע באפליקציה): הורה ₪9, מורה ₪29 — לחודש הראשון בלבד; מהחודש השני המחיר הרגיל (₪19/₪59).
• למי שלא רוצה מנוי: חבילת 5 חוברות ב-₪15 — תשלום חד-פעמי, בלי התחייבות, בלי תפוגה. כל חוברת בחבילה עד 10 עמודים + מפתח תשובות. נמצאת במסך "שדרגי" באפליקציה.
• חשוב — המכסה נספרת לפי חוברות, לא עמודים! חוברת של 20 עמודים = חוברת אחת בדיוק מהמכסה. מספר העמודים לא משפיע על המכסה.
