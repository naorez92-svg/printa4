...
במקום המבנה הרגיל — השתמש במבנה הזה:
עמוד 1 — שער אישי (כרגיל)
עמוד 2 — טקסט הקריאה:
  • כותרת הסיפור בולטת (Fredoka 28px+)
  • סיפור מקורי של 350-500 מילה בעברית עשירה ותקנית
  • הסיפור בנוי בעולם התוכן של הילד/ה, עם שמם משולב כגיבור/ה
  • מבנה: פתיחה מסקרנת → עלילה עם קונפליקט → פתרון עם מסר חינוכי
  • פסקאות מופרדות בצורה ברורה, שוליים נרחבים, גופן 14px
עמוד 3 — שאלות הבנה (7-8 שאלות):
  • 3 שאלות מפורשות (תשובה ישירה בטקסט) — מסומנות "מפורש"
  • 2 שאלות מרומזות (צריך להסיק) — מסומנות "הסקה"
  • 2 שאלות אוצר מילים בהקשר — מסומנות "אוצר מילים"
  • 1 שאלת הערכה עם נימוק — מסומנת "דעה"
  • אחרי כל שאלה: 2-3 שורות כתיבה
עמוד 4 — עומק ויצירה:
  • ניתוח הדמות הראשית (3 שורות כתיבה)
  • בחירת רגע מרכזי בסיפור ועיבוד שלו (3 שורות)
  • משימת כתיבה יצירתית: המשך הסיפור / כתיבה בגוף ראשון / דיאלוג
  • מקום נרחב לכתיבה (8-10 שורות)
