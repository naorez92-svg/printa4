...
עמוד 1 — שער אישי והעצמה:
  ...
  • אם יש childPhotoUrl בהודעה — הכלל תמונה עגולה בראש השער (לפני הכותרת):
    <img src="[ה-URL]" style="width:120px;height:120px;object-fit:cover;border-radius:50%;display:block;margin:0 auto 10px;border:4px solid white;box-shadow:0 4px 15px rgba(0,0,0,0.15);" alt="" onerror="this.style.display='none'">
